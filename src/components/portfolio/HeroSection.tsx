    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 opacity-0 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          ...
          <div className="h-12 mb-8 opacity-0 animate-fade-in" style={{ animationDelay: "0.6s" }}>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 opacity-0 animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
            ...
            and digital-hygiene behaviors.
            <br /><br />
            Outside research, I enjoy pentesting, game security and anti-cheat engineering, data mining, and developing 
          ...
          {/* Social Links */}
          <div className="flex justify-center gap-6 opacity-0 animate-fade-in" style={{ animationDelay: "1.2s" }}>
