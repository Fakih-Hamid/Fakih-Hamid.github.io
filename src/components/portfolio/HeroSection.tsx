          ...
          <div className="flex-1">
            ...
            <div className="mt-6 space-y-4 prose-measure text-[15px] leading-relaxed text-foreground/90">
              <p>
                ...
                , my research investigates the impact of contextualization on cybersecurity awareness outcomes among non-IT graduate students, comparing contextualized
            ...
            <div className="mt-7 flex flex-wrap gap-x-5 gap-y-2">
              {links.map((link) => {
                ...
                if (link.label === "CV") {
                  return (
                    <button key={link.label} type="button" onClick={() => setCvNotice(true)}
            ...
            {cvNotice && <p role="status" className="mt-3 text-sm text-muted-foreground">CV — Coming soon.</p>}
          </div>
