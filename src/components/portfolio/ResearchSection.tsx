...
const inProgress: Work[] = [
  {
    title:
      "Predwen: An Experimental Platform for a Randomized Comparison of Contextualized and Generic Cybersecurity Awareness Education",
    displayTitle: (
      <>
        Predwen: An Experimental Platform for a Randomized Comparison of{" "}
